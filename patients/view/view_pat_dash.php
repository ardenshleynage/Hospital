...
<body>
    ...
    <div class="app-container">
        ...
        <div class="app-content">
            ...
            <?php
            echo "Nombre de patients disponibles : {$num_pat}";
            ?><br>
                        ...
                        foreach ($all_pat as $row) {
                            ...
                            if ($row['id_service'] === null) {
                                ...
                                if ($service_row) {
                                    ...
                                    $update_query = "UPDATE `patient` SET `service` = :new_service WHERE `id` = :patient_id";
                                    $stmt_update_service = $pdo->prepare($update_query);
                                    $stmt_update_service->bindParam(':new_service', $new_service);
                                    $stmt_update_service->bindParam(':patient_id', $row['id']);
