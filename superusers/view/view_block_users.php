...
<head>
    <meta charset="UTF-8">
    <title>Utilisateurs Bloquer</title>
...
<body>
    ...
    <div class="app-container">
        ...
        <?php include ("../../menu/menu_block_users.php"); ?>

        <div class="app-content">
            <div class="app-content-header">
                <h1 class="app-content-headerText">Utilisateurs Bloquer</h1>
            ...
            <div class="app-content-actions">
                <form action="" method="post">
                    ...
                    <button type="submit" style="display: none;" name="search_block"
                ...
                <div class="app-content-actions-wrapper">
                    ...
                    <div class="filter-button-wrapper">
                        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                            <br><button type="submit" name="delete_all_block_entries"
            ...
            <?php
            echo "Nombre d'utilisateurs bloquées : {$num_block_users}";
            ?><br>
                ...
                <tbody>
                    ...
                    if ($blockusers) {
                        ...
                        foreach ($blockusers as $row) {
                            ...
                            ?>
                            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                                <input type="hidden" name="delete_block_entry" value="<?php echo $row['id']; ?>">
