...
(isset($_POST["log_out"])) {
  ...
  // Redirige vers une page de connexion par exemple
  header("location:http://localhost/website/UML/final_php/users/view/view_log_users.php");
  exit();
} ?>
...
<div class="sidebar">
  ...
  <ul class="sidebar-list">
    <li class="sidebar-list-item">
      <a href="http://localhost/website/UML/final_php/users/view/view_home_dash.php">
